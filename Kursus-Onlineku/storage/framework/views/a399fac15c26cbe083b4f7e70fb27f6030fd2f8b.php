...
<head>
    ...
    <title><?php echo e(__('auth.register_title')); ?> — Learnify</title>
                            ...
                            <div class="col-12">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"><?php echo e(__('auth.register_heading')); ?></h1>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <input type="text"
                                                class="form-control form-control-user <?php $__errorArgs = ['alamat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="<?php echo e(__('auth.address_optional')); ?>"
                                                name="alamat"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <input type="text"
                                                class="form-control form-control-user <?php $__errorArgs = ['kota'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="<?php echo e(__('auth.city_optional')); ?>"
                                                name="kota"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            <input type="password"
                                                ...
                                                placeholder="<?php echo e(__('auth.password_confirm')); ?>"
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="<?php echo e(route('login')); ?>"><?php echo e(__('auth.have_account')); ?></a>
                                    </div>
...
<?php /**PATH C:\Users\luizz\Kursus-Onlineku\resources\views/auth/register.blade.php ENDPATH**/ ?>